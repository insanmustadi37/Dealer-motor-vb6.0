...
Begin VB.Form BeliKredit 
   BackColor       =   &H00808080&
   Caption         =   "Transaksi Kredit Kelompok 6"
   ClientHeight    =   2820
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6600
   ...
   Begin VB.TextBox LblHargaCash 
      ...
      Width           =   1500
   End
   Begin VB.TextBox LblHargaKredit 
      BackColor       =   &H00FFFFFF&
      Height          =   350
      Left            =   1680
      TabIndex        =   23
...
Cetak.Show vbModal
Cetak.Label1 = "BUKTI PEMBAYARAN DEALER MOTOR" + Chr(13) + Chr(13) + Chr(13) + Chr(13) + "Nama : " + LblNama.Text + Chr(13) + Chr(13) + "UangMuka : " + TxtDP.Text + Chr(13) + Chr(13) + "Bunga : " + TxtBunga.Text + Chr(13) + Chr(13) + "Lama Cicilan : " + TxtLama.Text + Chr(13) + Chr(13) + "Angsuran : " + LblAngsuran.Text + Chr(13) + Chr(13) + "ID KREDIT :" + IdKredit.Text + Chr(13) + Chr(13) + "Tanggal : " + Tanggal.Text + Chr(13) + Chr(13) + "Merk : " + LblMerk.Text + Chr(13) + Chr(13) + "Harga Cash : " + LblHargaCash.Text + Chr(13) + Chr(13) + "Harga Kredit : " + LblHargaKredit.Text
